...
public class DataLogger : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Archivo de datos se guardará en: " + filePath);
    ...
    public void StopLogging()
    {
        ...
        try
        {
            ...
            // Mostrar ruta en VR (útil para encontrar el archivo después)
    ...
    void WriteHeaders()
    {
        ...
        // Remover última coma y agregar nueva línea
        csvBuilder.Length--;
    ...
    public void LogFacialData(FacialExpressionCapture.FacialData data)
    {
        ...
        try
        {
            ...
            // Flush periódicamente para evitar pérdida de datos
    ...
    void ShowFilePathInConsole()
    {
        ...
        Debug.Log("3. Navega a: Quest 2 > Internal Storage > Android > data > com.tucompañia.FacialTracking > files");
        Debug.Log("=================================================");
    }
